...
%---------------------------------------------------------------
(learner <-> teacher)
(the teacher delegates the questions to the interactive learnable, which in turn delegates to the user ...)
...
%---------------------------------------------------------------
(valami jobb cím: a könnyen felfedezhető részek nyilvántartása, controlling the design space exploration, design space optimization, knowing what is unknown, reducing the cost of exploration, controlling design space partitions, abstract space partitioning, concept class)
